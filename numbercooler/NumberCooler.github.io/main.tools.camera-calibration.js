...
Router.addPage({name:"tools.camera-calibration",template:"base"},function(args, template, router) {
	...
	*/
	...
	concept1.drawing({
		...
		source: localStorage.getItem("index.flat.vs.glsl"),
		location_points : 3,
	...
	concept1.material({
		//source: localStorage.getItem("blue.fs.glsl"),
		color : "#0f0"
	});
	...
	// how to check with differente resolutions, on demmand?
