...
Router.addPage({name:"tools.deg_tan",template:"base"},function(args, template, router) { // this is coupled, requires temporary.musicplayer defined
	...
	for(var x = 0; x <= 90;x++) {
		...
		td0.innerHTML = x;
		td1.innerHTML = Math.tan( x * Math.PI/ 180 );
	}
