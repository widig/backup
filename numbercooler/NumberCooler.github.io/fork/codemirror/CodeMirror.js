...
(function(mod) {
  ...
  function registerEventHandlers(cm) {
	...
	on(inp, "keyup", function(e) { console.log("CM.KEYUP"); onKeyUp.call(cm, e); });
		...
		if (persistent && cm.openDialog) {
			...
			persistentDialog(cm, queryDialog, q, function(query, event) {
				...
				findNext(cm, event.shiftKey, function(_, to) {
					var dialog;
					if (to.line < 3 && document.querySelector && (dialog = cm.display.wrapper.querySelector(".CodeMirror-dialog")) &&
...
(function(mod) {
	...
	CodeMirror.keyMap["default"]["Shift-Delete"] = "deleteLine";
	CodeMirror.keyMap["default"]["Ctrl-H"] = "replace";
	
	//CodeMirror.keyMap["default"]["F2"] = "nextBookmark";
	//CodeMirror.keyMap["default"]["Shift-F2"] = "prevBookmark";
	//CodeMirror.keyMap["default"]["Ctrl-F2"] = "toggleBookmark";
